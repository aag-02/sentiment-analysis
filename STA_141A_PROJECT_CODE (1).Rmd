...
update.frame <- data.frame(player_name = all_seasons$player_name, draft_year = draft.yr.num, draft_round = draft.round.num, draft_pick = draft.pick.num, pts = all_seasons$pts, reb = all_seasons$reb, ast = all_seasons$ast) 
