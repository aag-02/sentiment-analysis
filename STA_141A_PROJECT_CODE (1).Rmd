...
library(GGally)
library(ISLR)
#all_seasons <- read.csv("C:/Users/jared/Downloads/all_seasons.csv")
...
Player.Award.Shares <- read.csv("~/Downloads/Player Award Shares.csv")
...
```{r}
# everything past here is just work i've been doing so it might be redundant to what ur tryna do
...
#bot 3 are all in doc and same as 3 above, not gonna use these
...
ggplot(data = regression.class, mapping = aes(x = tier, y = career.score)) +
    ...
    labels = c("Tier 1" = "1-10",
               ...
               "Tier 4" = "31-40",
               "Tier 5" = "41-50",
               "Tier 6" = "51 and Beyond")) + labs(color='Tiers (Organized by Picks)') #this is a good plot 
